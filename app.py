...
# 1. المجموعات كاملة
groups = {
    "المجموعة A": ["كندا", "إسبانيا", "السنغال", "نيوزيلندا"],
    "المجموعة B": ["المكسيك", "مصر", "النمسا", "أستراليا"],
    "المجموعة C": ["أمريكا", "المغرب", "إيطاليا", "هندوراس"],
    "المجموعة D": ["البرازيل", "إسكتلندا", "كوريا الجنوبية", "كرواتيا"],
    "المجموعة E": ["إنجلترا", "اليابان", "تونس", "كولومبيا"],
    "المجموعة F": ["فرنسا", "ألمانيا", "نيجيريا", "بولندا"],
    "المجموعة G": ["الأرجنتين", "بلجيكا", "السعودية", "أوروغواي"],
    "المجموعة H": ["البرتغال", "سويسرا", "غانا", "صربيا"],
    "المجموعة I": ["هولندا", "المكسيك", "إيران", "النرويج"],
    "المجموعة J": ["الدنمارك", "تشيلي", "المجر", "اليونان"],
    "المجموعة K": ["إسبانيا", "تركيا", "الجزائر", "أيرلندا"],
    "المجموعة L": ["إيطاليا", "الباراغواي", "السويد", "قطر"]
}
